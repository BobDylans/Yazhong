    ...
    <>
      ...
      <main className="pt-[106px] min-h-screen">
        ...
        <section className="py-16 md:py-20">
          <div className="max-w-[1400px] mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold text-[#202626] mb-6">
                Our Story
              </h2>
        ...
        <section className="py-16 bg-[#f5f5f5]">
          <div className="max-w-[1400px] mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-[#202626] text-center mb-12">
              Why Choose Yazhong
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((v) => {
                ...
                return (
                  ...
                  >
                    <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[#f0f7fd] text-[#45a0de]">
                      <Icon className="h-8 w-8" strokeWidth={1.5} />
                    </div>
                    <h3 className="font-semibold text-[#191d21] mb-2">
                      {v.title}
                    </h3>
                    <p className="text-sm text-[#808080]">{v.desc}</p>
                  </div>
                );
              })}
            </div>
        ...
        <section className="py-16 text-center">
          <div className="max-w-[1400px] mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-[#202626] mb-4">
